...
<body>
	<form action="join" method="post" name="f"
		...
		<h3 class="h3Txt">홈구장안내</h3>
		<div class="seat_position">
			<span class="img-map"><img src="../../image/map2.jpg"
				alt="좌석배치도" /></span>
		</div>
		<h4 class="h4Txt">좌석배치도</h4>
		...
		<div id="contents">
			...
			<p class="subtxt">대전광역시 중구 부사동 177-1 (보문산공원 입구)</p>
		</div>
		...
		<br> <img src="../../image/map1.png" alt="약도 이미지" />
		<h5>교통편</h5>
		<ul class="ul_type1">
