	...
	<div id="main_div">
		<div id="contents">
			...
			<form name="form" action="">
				<fieldset>
					<select name="sg" onchange="form.submit();" title="시즌선택"
						...
						<option value="011" selected='selected'>- NH농협 2022-2023
							V-리그</option>
						...
						<tr class="current">
							...
							<td><p>
									<img class=logoimg src="${path}/image/logo/logo_kgc.png"
										alt="KGC인삼공사" class="logo" />KGC인삼공사
								</p></td>
							<!-- alt값은 팀명에 따라 변경됨 -->
							<td>36</td>
							<td>19</td>
						...
						<tr class="">
							...
							<td><p>
									<img class=logoimg src="${path}/image/logo/logo_IBK.png"
										alt="IBK기업은행" class="logo" />IBK기업은행
								</p></td>
							<!-- alt값은 팀명에 따라 변경됨 -->
							<td>36</td>
							<td>15</td>
