...
<div class="w3-top">
	<div class="w3-bar w3-theme-d2 w3-left-align">
		...
		<a href="../member/joinForm.jsp" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" title="Join">JOIN</a>
		<a href="../member/loginForm.jsp" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" title="Login">LOGIN</a>
	</div>
